...
class ClassClienteDAO {
    ...
    public function excluircliente (ClassCliente $excluircliente){
        ...
        if ($_SESSION['id_usuario'] !== $excluircliente->getExcluirid()) {
            throw new Exception("Você não tem permissão para excluir este cliente.");
        }
    ...
    public function alterarcliente (ClassCliente $alterarcliente){
        try{
            ...
            if ($_SESSION['id_usuario'] !== $alterarcliente->getNovoid()) {
                throw new Exception("Você não tem permissão para alterar este cliente.");
            }
