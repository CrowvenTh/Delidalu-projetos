...
switch($acao){
    case "addProduto":
        ...
        if($addproduto >= 1){
            header('Location:../view/CRUDProduto.php?&MSG= Produto adicionado com sucesso ao estoque!');
        } else {
            header('Location:../view/CRUDProduto.php?&MSG= Não foi possivel adicionar produto ao estoque!');
        }
